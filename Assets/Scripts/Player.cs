...
public class Player : MonoBehaviour
{
    ...
    private void OnDisable() // Enable과 반대!
    {
    ...
    private void OnBomb(InputAction.CallbackContext obj) // 빠른작업 및 리팩터링-메서드추출 => 자동생성활용
    {
        Debug.Log("Bomb");
    }
    ...
    private void OnMoveInput(InputAction.CallbackContext context) //이동 관련
    {
        ...
        inputDir = dir; //움직임 스무스하게 하기위한 작업 3
    ...
    void Update()
    {
        ...
        //transform.position += (Vector3)inputDir;//움직임 스무스하게 하기위한 작업 4
